        ...
        <div class="app-page-title">
          <div class="page-title-wrapper">
            <div class="page-title-heading">
              ...
              <div>
                {{ $store.getters.GET_MY +' '+$store.getters.GET_ATTENDANCE+' '+ $store.getters.GET_RECORDS}}
              </div>
            </div>
          </div>
        </div>
        <div id="accordion" class="acordinContainer">
          <div class="searchFormCard">
            ...
            >
              <hr />
              <div class="card-body">
                <form action @submit.prevent="searchAttendance">
                  <div class="form-row">
                    <div class="col-md-4">
                      <label>
                      ...
                      <div class="form-group">
                        <select
                          ...
                          required
                        >
                          <option value="" >{{$store.getters.GET_SELECT+" "+$store.getters.GET_YEAR}}</option>
                          <option
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          <select
                            ...
                            class="form-control"
                          >
                            <option value="">{{$store.getters.GET_SELECT+" "+$store.getters.GET_MONTH}}</option>
                            <option
                          ...
                          <div class="input-group-append">
                            <button @click="resetMonth()" type="button" class="btn btn-base btn-sm">
                    ...
                    <div class="col-md-2 mt-2 ml-4">
                      ...
                      <br /> -->
                      <div class="form-group">
                        <button type="submit" class="btn btn-base btn-lg float-left">
                          {{ $store.getters.GET_SEARCH}}
                          <i class="fa fa-search"></i>&nbsp;
                        </button>
          ...
          <div class="col-12">
            <div class="main-card card">
              <div class="text-left ml-4">
                <h5>{{$store.getters.GET_ATTENDANCE+' '+ $store.getters.GET_RECORDS}}</h5>
          ...
          <span class="color-box red"></span>Other Holiday
              ...
              <div id="navbar-example">
                ...
                <ul class="nav nav-tabs mt-3">
                  <li class="nav-item" v-for="(item, index) in attendance_months" :key="index">
                    <a
                      class="nav-link"
                      data-toggle="tab"
                      :class="[activeMonth == item.numeric ? 'active' : nulll,AttendanceMonth && activeMonth != item.numeric
                          ? 'disabled'
                          : null,
                      ]"
                      role="tab"
                ...
                <!-- Tab panes {Fade}  -->
                <AddAttendanceModal v-if="AddModalVisible" :attendance_date="AttendanceNewDate" />
                <UpdateAttendanceModal v-if="UpdateModalVisible" />
                <div>
                            ...
                            <tbody>
                              <template v-for="(Attdance, index) in newAttdanceList" :key="index">
                                <tr :class="{'holiday':checkHoliday(Attdance.day)}">
                                  ...
                                  <!-- <template
                                    v-if="hasPermission('add_attendancerecord') && hasPermission('change_attendancerecord') "
                                  >
                                    <td
                                      class="td_action"
                                      v-if="
        ...
        <div class="row" v-else>
          <div class="col-12 mt-2">
             <div class="alert alert-success">
               {{ $store.getters.GET_TO_SEE }} <strong>{{$store.getters.GET_ATTENDANCE+' '+ $store.getters.GET_RECORDS}}</strong> {{ $store.getters.GET_PLEASE_PERFORM_A_SEARCH }}!
            </div>
            <!-- <div class="main-card card">
