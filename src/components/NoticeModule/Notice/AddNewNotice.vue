    ...
    <template v-slot:content>
      <div class="app-main__inner">
        <div class="app-page-title">
          <div class="page-title-wrapper">
            <div class="page-title-heading">
              ...
              <div>
                {{
                  $store.getters.GET_CREATE + " " + $store.getters.GET_NOTICE
                }}
                <router-link
                  :to="{ path: '/all-notices' }"
        ...
        <div class="main-card card">
          <div class="card-body">
            <form @submit.prevent="submitNoticeForm">
              <div class="form-group">
                <div class="form-row">
                  ...
                  <div class="col-md-12 mt-2 mb-2">
                    ...
                    <div
                      v-if="hasAllUserChecked == false && to_whom.length == 0"
                  ...
                  <div class="col-md-12">
                    ...
                    />
                    <!--  @send-fileError="ReceivedFileError" -->
                  </div>
                </div>
                <div class="form-group">
                  <button
                    @submit.prevent="submitNoticeForm"
                    class="mt-2 btn btn-successs btn-lg float-right"
                    :disabled="is_disable"
                  >
                    <!-- :class="[is_submit ? 'is-active' : null]"
                    :aria-disabled="is_submit" -->
...
export default {
  ...
  methods: {
    ...
    IsUserCkecked() {
      ...
      //   this.to_whom = [];
      // } else {
      //   this.to_whom = this.all_groups_ids;
      // }
    },
    ReceivedFilesRelated(value) {
      console.log("302  realted", value);
    ...
    // ReceivedFileError(value) {
    //   console.log("314 file error", value);
    //   if (value != null) {
    //     this.is_submit = true;
    //     // this.is_submit = !this.is_submit;
    //   }
    ...
    async submitNoticeForm() {
      if (this.hasAllUserChecked == false && this.to_whom.length == 0) {
        ...
        const response = await axios
          .post("notices/", {
            ...
            // to_whom: this.to_whom.length > 0 ? this.to_whom : [],
            to_whom:
              this.to_whom.length > 0 ? this.to_whom : this.all_groups_ids,
            // if( this.hasAllUserChecked == false && this.to_whom.length == 0){
            //   alert("Hello! I am an alert box!!");
            // }
          })
    ...
    loadGroup() {
      axios
        ...
        .then((response) => {
          ...
          this.all_groups_ids = this.all_groups.map((y) => y.id);
          // this.to_whom = this.all_groups_ids;
        })
