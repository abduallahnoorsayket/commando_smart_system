...
export default {
  ...
  created() {
    this.Comment_Id = this.$store.state.comment.CommentId;
    this.Content_Type = this.$store.state.comment.CommentContentType;
    this.Object_Id = this.$store.state.comment.CommentObjectId;
  ...
  methods: {
    ...
    getCommentDetail() {
      this.loading = true;
      axios
        .get("comment-module/" + this.Comment_Id + "/")
        .then(
          (response) => {
